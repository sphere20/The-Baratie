...
public class Feedback extends JFrame implements ActionListener,MouseListener{
    ...
    Feedback() {
        this.setTitle("The Baratie (Feedbacks)");
        ...
        try
        {
          br = new BufferedReader(new FileReader("reviews.txt"));
        ...
        ImageIcon b = new ImageIcon("C:/Users/mahim/Desktop/The Baratie/icon/review.jpg");
