...
public class AHome extends JFrame implements MouseListener,ActionListener {

	private ImageIcon pic,ib,ib2,ib3; 
	private JButton lb,rb,mb,hb,p,fb;
	private JLabel l,r,r2,r3;
   
      
	AHome(){

		 this.setTitle("The Baratie (Admin Homepage)");
        ...
        jp.setCursor(cursor);
         ...
         fb = new JButton("Feedbacks");
        fb.setBounds(790,500,120,25);
         fb.setFont(new Font("Raleway", Font.BOLD,12));
         ...
         ib = new ImageIcon("C:/Users/mahim/Desktop/The Baratie/icon/bgp.jpg");
